...
class FIFOPageReplacementAlgorithm:
    def __init__(self, page_frame: PageFrame, page_table: PageTable, tlb_cache: TLBCache):
    ...
    def replace_page(self, new_page):
        ...
        print(f"Page fault occurred. Page {new_page.content} loaded into frame {'NONE'}.")
...
def simulate_memory_management_lru(pages: List[MemoryPage], num_frames: int):
    ...
    lru_algorithm = LRUPageReplacementAlgorithm(page_frames, page_table, tlb_cache)
